    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (!endApp)
            {
                ...
                for (int i = 0; i < N; i++)
                {
                    RandomArray[i] = rnd.NextDouble() * RandomLimit;
                }
                Console.WriteLine("------------------------------");
                Console.Write("Your array is:------------->");
                printIt(RandomArray);
                string operation = EnterMethod();
                OperationHandling(operation, RandomArray);
        ...
        static void OperationHandling(string operation, double[] RandomArray)
        {
            switch (operation)
            {
                case "1":
        ...
        //this function is helping to see that our array is not changing.
        ...
        static void F3(double[] arr)
        {
            ...
            Console.WriteLine("Memory usage:{0}", MergeSort.memory);
            MergeSort.memory = 0;
            Console.WriteLine();
        }
